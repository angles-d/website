...
const content = [
    ...
    <div className="embed-responsive embed-responsive-16by9 mb-4">
        <iframe  className="mb-4 pl-4 pr-4" src="https://www.youtube.com/embed/tW86dV27mk8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>,
    ...
    <div className="d-flex justify-content-center">
        <img className="" src={letsBuildGif}/>
    </div>
]
